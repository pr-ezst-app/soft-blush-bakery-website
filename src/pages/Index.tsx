            ...
            {[
              {
                ...
                emoji: "🍓",
                options: [
                  { label: "Individual (1 jar)", price: "$12–$13" },
                  { label: "Set of 4", price: "$44" },
                  { label: "Set of 6", price: "$64" },
                  { label: "Party Pack (12)", price: "$120" },
                ],
                highlight: false,
              ...
              },
              {
                ...
                emoji: "🧁",
                options: [
                  { label: "Single cupcake", price: "$5–$6" },
                  { label: "Box of 6", price: "$28" },
                  { label: "Box of 12", price: "$54" },
                  { label: "Box of 24", price: "$100" },
                ],
                highlight: true,
              ...
              },
              {
                ...
                emoji: "🍪",
                options: [
                  { label: "Single cookie", price: "$3.50–$4.50" },
                  { label: "Bag of 6", price: "$22" },
                  { label: "Bag of 12", price: "$40" },
                  { label: "Custom decorated set", price: "from $50" },
                ],
                highlight: false,
